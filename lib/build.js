...
function webpackConfig(
  ...
  var functionsDir = distDir;
  var functionsPath = path.resolve(path.join(process.cwd(), functionsDir));
  var dirPath = path.resolve(path.join(process.cwd(), srcDir));
...
exports.run = function (dir, srcDir, additionalConfig) {
  return new Promise(function (resolve, reject) {
    webpack(webpackConfig(dir, srcDir, additionalConfig), function (
      err,
      stats
    ) {
      if (err) {
